...
* [richpeck/exception_handler](https://github.com/richpeck/exception_handler) - ⭐ Exception Handler ⭐ Ruby on Rails 4 & 5 Gem. ONLY authentic solution to provide custom error pages (no overhead) →
