...
* [Homebrew/linuxbrew-core](https://github.com/Homebrew/linuxbrew-core) - :beers::penguin: Core formulae for the Homebrew package manager on Linux
...
* [rubygarage/truemail](https://github.com/rubygarage/truemail) - 🚀 Configurable plain Ruby 📨 email validator. Verify email via Regex, DNS and SMTP. Be sure that email address valid and exists.
