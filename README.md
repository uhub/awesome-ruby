...
* [httprb/http](https://github.com/httprb/http) - The HTTP Gem: a fast Ruby HTTP client with a chainable API, streaming support, and timeouts
...
* [janko-m/shrine](https://github.com/janko-m/shrine) - File upload toolkit for Ruby
...
* [pakyow/pakyow](https://github.com/pakyow/pakyow) - Realtime Web Framework for Ruby
