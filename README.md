...
* [ruby-grape/grape](https://github.com/ruby-grape/grape) - An opinionated micro-framework for creating REST-like APIs in Ruby.
...
* [neo/ruby_koans](https://github.com/neo/ruby_koans) - A set of Koans to teach the Ruby language
...
* [DavyJonesLocker/client_side_validations](https://github.com/DavyJonesLocker/client_side_validations) - ClientSideValidations for Ruby on Rails
...
* [brandonhilkert/sucker_punch](https://github.com/brandonhilkert/sucker_punch) - Sucker Punch is a Ruby asynchronous processing library using Celluloid, heavily influenced by Sidekiq and girl_friday.
...
* [radar/guides](https://github.com/radar/guides) - Ruby Guides
...
* [hybridgroup/artoo](https://github.com/hybridgroup/artoo) - Ruby robotics framework using Celluloid
...
* [kpumuk/meta-tags](https://github.com/kpumuk/meta-tags) - Search Engine Optimization (SEO) plugin for Ruby on Rails applications.
...
* [davidcelis/recommendable](https://github.com/davidcelis/recommendable) - A recommendation engine using Likes and Dislikes for your Ruby/Redis application.
...
* [httprb/http](https://github.com/httprb/http) - http.rb: a fast Ruby HTTP client with a chainable API and full streaming support
...
* [jwt/ruby-jwt](https://github.com/jwt/ruby-jwt) - JSON Web Token implementation in Ruby
...
* [airbrake/airbrake](https://github.com/airbrake/airbrake) - The official Airbrake library for Ruby on Rails. Links to other Airbrake libraries are in the ReadMe.
* [YorickPeterse/ruby-lint](https://github.com/YorickPeterse/ruby-lint) - Static code analysis for Ruby.
...
* [janlelis/irbtools](https://github.com/janlelis/irbtools) - Improvements for Ruby's IRB
...
* [danlucraft/redcar2](https://github.com/danlucraft/redcar2) - A cross-platform programmer's editor written in Ruby. Official repo: https://github.com/redcar/redcar/
...
* [pawurb/termit](https://github.com/pawurb/termit) - Google Translate with speech synthesis in your terminal as ruby gem
...
* [pusher/pusher-http-ruby](https://github.com/pusher/pusher-http-ruby) - Ruby server library for the Pusher API
...
* [jugend/amazon-ecs](https://github.com/jugend/amazon-ecs) - Generic Ruby Amazon Product Advertising API
...
* [lewagon/fullstack-challenges](https://github.com/lewagon/fullstack-challenges) - 9-weeks Paris Ruby on Rails bootcamp for entrepreneurs
...
* [rrrene/inch](https://github.com/rrrene/inch) - A documentation measurement tool for Ruby, based on YARD
...
* [EricR/image_sorcery](https://github.com/EricR/image_sorcery) - A ruby Image/Graphics Magick library.
* [petrovich/petrovich-ruby](https://github.com/petrovich/petrovich-ruby) - A library to inflect Russian anthroponyms such as first names, last names, and middle names.
...
* [sumoheavy/jira-ruby](https://github.com/sumoheavy/jira-ruby) - A Ruby gem for the JIRA 5 REST API
* [netzke/netzke-core](https://github.com/netzke/netzke-core) - A framework for elegant Sencha Ext JS Ruby on Rails components
...
* [getsentry/raven-ruby](https://github.com/getsentry/raven-ruby) - Raven is a Ruby client for Sentry (getsentry.com)
...
* [basho/riak-ruby-client](https://github.com/basho/riak-ruby-client) - Ruby client for Riak
...
* [weppos/publicsuffix-ruby](https://github.com/weppos/publicsuffix-ruby) - Domain Name parser based on the Public Suffix List.
* [packetfu/packetfu](https://github.com/packetfu/packetfu) - PacketFu, a mid-level packet manipulation library for Ruby
* [RailsApps/learn-rails](https://github.com/RailsApps/learn-rails) - An example Rails 4.2 app to accompany the "Learn Ruby on Rails" book.
...
* [c42/wrest](https://github.com/c42/wrest) - A fluent, easy-to-use, object oriented Ruby HTTP/REST client library with support RFC2616 HTTP caching and async calls that runs on CRuby, JRuby and rbx.
...
* [azabaj/acts_as_rateable](https://github.com/azabaj/acts_as_rateable) - Acts_as_rateable is a Ruby  on Rails plugin which makes ActiveRecord models rateable through a polymorphic association and optionally logs which user rated which object. This plugin is used in production and Rails 3 compatible.
...
* [janlelis/clipboard](https://github.com/janlelis/clipboard) - Ruby access to the clipboard on Linux, MacOS and Windows
...
* [danlucraft/redcar](https://github.com/danlucraft/redcar) - A cross-platform programmer's editor written in Ruby. Official repo: https://github.com/redcar/redcar/
* [huacnlee/ruby-china](https://github.com/huacnlee/ruby-china) - Ruby China 代码，这边已经不再提交，已经移动到了 ruby-china 账号下面
