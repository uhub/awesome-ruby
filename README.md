...
* [spree/spree](https://github.com/spree/spree) - Spree is an open source E-commerce platform for Rails 6 with a modern UX, optional PWA frontend, REST API, GraphQL, several official extensions and 3rd party integrations. Join our Slack with 4000 users!
...
* [phallstrom/slackistrano](https://github.com/phallstrom/slackistrano) - Slack integration for Capistrano deployments.
...
* [rubygarage/truemail](https://github.com/rubygarage/truemail) - 🚀 Configurable framework agnostic plain Ruby 📨 email validator. Verify email via Regex, DNS and SMTP. Be sure that email address valid and exists.
...
* [ruby2d/ruby2d](https://github.com/ruby2d/ruby2d) - :video_game: The Ruby 2D gem
...
* [mdeering/gravatar_image_tag](https://github.com/mdeering/gravatar_image_tag) - A configurable and documented Rails view helper for adding gravatars into your Rails application
...
* [spacialdb/fcm](https://github.com/spacialdb/fcm) - Ruby bindings to Firebase Cloud Messaging (FCM) for Android, iOS or Web
...
* [hashrocket/hr-til](https://github.com/hashrocket/hr-til) - Today I Learned in Ruby
* [sous-chefs/ruby_rbenv](https://github.com/sous-chefs/ruby_rbenv) - Development repository for the ruby_rbenv cookbook
...
* [grosser/fast_gettext](https://github.com/grosser/fast_gettext) - Ruby GetText, but 12x faster + 530x less garbage + simple + clean namespace + threadsave + extendable + multiple backends
...
* [scaffeinate/socify](https://github.com/scaffeinate/socify) - :rocket: Socify is an open source social networking platform written in Ruby on Rails
...
* [continuum/active_importer](https://github.com/continuum/active_importer) - Define importers that load tabular data from spreadsheets or CSV files into any ActiveRecord-like ORM.
...
* [eval/envied](https://github.com/eval/envied) - Ensures presence and type of your app's ENV-variables (mirror)
...
* [aleks/ansible-rails](https://github.com/aleks/ansible-rails) - Ansible: Ruby on Rails Server
...
* [CarletonStuberg/browser-backdoor](https://github.com/CarletonStuberg/browser-backdoor) - BrowserBackdoor is an Electron Application with a JavaScript WebSocket Backdoor and a Ruby Command-Line Listener
...
* [Ruleby/ruleby](https://github.com/Ruleby/ruleby) - the Rules Engine for Ruby
...
* [Linuxbrew/homebrew-core](https://github.com/Linuxbrew/homebrew-core) - :beers::penguin: Core formulae for the Linuxbrew package manager
...
* [ruby-hyperloop/hyper-react](https://github.com/ruby-hyperloop/hyper-react) - The project has moved to Hyperstack!!
...
* [weavenet/trello_cli](https://github.com/weavenet/trello_cli) - Experimental - Trello Command Line Interface - Ruby Gem
...
* [rubocop-rspec/rubocop-rspec](https://github.com/rubocop-rspec/rubocop-rspec) - Code style checking for RSpec files
...
* [backus/rubocop-rspec](https://github.com/backus/rubocop-rspec) - Code style checking for RSpec files
...
* [waferbaby/usesthis](https://github.com/waferbaby/usesthis) - A nerdy little interview website, asking people what they use to get stuff done.
...
* [Everapps/stripe-rails](https://github.com/Everapps/stripe-rails) - A Rails Engine for integrating with stripe.com
...
* [randx/six](https://github.com/randx/six) - ultra lite authorization library
...
* [twe4ked/rspec-nc](https://github.com/twe4ked/rspec-nc) - 🚦 RSpec formatter for OS X's Notification Center
...
* [zach-capalbo/flammarion](https://github.com/zach-capalbo/flammarion) - The nifty ruby gui toolkit.
...
* [inesita-rb/inesita](https://github.com/inesita-rb/inesita) - Frontend web application framework in Ruby using Opal.
...
* [wit-ai/wit-ruby](https://github.com/wit-ai/wit-ruby) - Ruby library for Wit.ai
...
* [paulrayner/ddd_sample_app_ruby](https://github.com/paulrayner/ddd_sample_app_ruby) - Idiomatic Ruby port of the DDD sample application
...
* [sudharti/socify](https://github.com/sudharti/socify) - Socify is an open source social networking platform written in Ruby on Rails
